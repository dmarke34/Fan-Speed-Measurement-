...
void Update_Screen(void)
{
    ...
    DC_Txt[0] = duty_cycle/100  + '0';          // Get hundredth place of duty cycle
    DC_Txt[1] = ((duty_cycle/10)%10) +'0';      // Get tenth place of duty cycle
    DC_Txt[2] = (duty_cycle%10) + '0';          // Get ones place of duty cycle

    
    RPM_Txt[0] = rpm/1000  + '0';               // Get thousandth place of rpm
    RPM_Txt[1] = ((rpm/100)%10)+'0';            // Get hundredth place of rpm
    RPM_Txt[2] = ((rpm/10)%10)+'0';             // Get tenth place of rpm
    RPM_Txt[3] = ((rpm)%10)+'0';                // Get ones place of rpm
